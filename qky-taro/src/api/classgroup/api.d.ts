export namespace classgroup {
  ...
  export class GroupUserRel {
    /** basGroup */
    basGroup: classgroup.BasGroup;

    /** basUser */
    basUser: classgroup.BasUser;
  ...
  export class Page<T0 = any> {
    ...
    /** pageable */
    pageable: classgroup.Pageable;

    /** size */
    size?: number;

    /** sort */
    sort: classgroup.Sort;
  ...
  export class SystemUser {
    ...
    /** 分组数量统计 */
    statisticalGroupMemberNumber: classgroup.StatisticalGroupMemberNumber;
...
export namespace classgroup {
  ...
  export namespace basGroup {
    ...
    export namespace queryByCode {
      ...
      export type ResponseType = Promise<classgroup.BasGroup>;
      export function request(params: Params): ResponseType;
    }
    ...
    export namespace statisticalGroupMemberNumber {
      export type ResponseType = Promise<
        classgroup.StatisticalGroupMemberNumber
      >;
      export function request(bodyParams: any): ResponseType;
    }
  }
  ...
  export namespace basUser {
    ...
    export namespace getUserRelByUserId {
      export type ResponseType = Promise<classgroup.GroupUserRel[]>;
      export function request(bodyParams: any): ResponseType;
    }
  ...
  export namespace bizEnroll {
    ...
    export namespace queryByGroupId {
      ...
      export type ResponseType = Promise<classgroup.Page<classgroup.BizEnroll>>;
      export function request(params: Params): ResponseType;
    }
    ...
    export namespace view {
      ...
      export type ResponseType = Promise<classgroup.BizEnroll>;
      export function request(params: Params): ResponseType;
    }
  }
  ...
  export namespace bizMessage {
    ...
    export namespace queryByGroupId {
      ...
      export type ResponseType = Promise<
        classgroup.Page<classgroup.BizMessage>
      >;
      export function request(params: Params): ResponseType;
    }
  }
  ...
  export namespace bizNotice {
    ...
    export namespace add {
      export type ResponseType = Promise<boolean>;
      export function request(bodyParams: classgroup.BizNotice): ResponseType;
    }
    ...
    export namespace queryByGroupId {
      ...
      export type ResponseType = Promise<classgroup.Page<classgroup.BizNotice>>;
      export function request(params: Params): ResponseType;
    }
    ...
    export namespace view {
      ...
      export type ResponseType = Promise<classgroup.BizNotice>;
      export function request(params: Params): ResponseType;
    }
  }
  ...
  export namespace system {
    ...
    export namespace getInfo {
      export type ResponseType = Promise<classgroup.SystemUser>;
